    ...
    const response = await axios.post(
      'https://api.groq.com/openai/v1/chat/completions',
      {
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a financial news editor. Always respond with valid JSON only. No markdown, no backticks.'
          },
          {
            role: 'user',
            content: `Write a news card for this article.

Rules:
- "headline": A clear, concluded sentence under 12 words. Must end with a full stop. Summarise what actually happened, do NOT just repeat the title.
- "story": One natural paragraph. Explain what happened, include key facts, numbers, names. Then explain why it matters. Keep it concise — no fluff, no predictions. End with a full stop.
